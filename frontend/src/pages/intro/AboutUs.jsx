...
return (
    ...
    >
        ...
        >
            <h2 className="text-4xl not-md:text-2xl font-bold text-red-500 mb-6">Về chúng tôi</h2>
        ...
        >
            ...
            <div className="grid grid-cols-3 gap-8 not-md:grid-cols-1">
                ...
                >
                    ...
                    <h4 className="text-2xl not-md:text-xl font-bold mb-3">Đổi mới</h4>
                ...
                >
                    ...
                    <h4 className="text-2xl not-md:text-xl font-bold mb-3">Chất lượng</h4>
                ...
                >
                    ...
                    <h4 className="text-2xl not-md:text-xl font-bold mb-3">Đồng đội</h4>
        ...
        >
            ...
            <div className="grid grid-cols-4 gap-6 not-md:grid-cols-1">
