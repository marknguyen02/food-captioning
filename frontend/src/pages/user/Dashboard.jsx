...
const Dashboard = () => {
    ...
    const WidgetWrapper = ({ title, children, icon, iconColor }) => (
        <div className="bg-gray-900 rounded-xl shadow-xl border border-gray-800 overflow-hidden 
            ...
            <div className="px-4 py-8 bg-gray-800 overflow-auto max-h-[700px]">
                {children}
            </div>
        </div>
    );
    ...
    return (
        <div className="flex flex-col gap-5 w-full h-full bg-[#20262E] items-center overflow-auto py-5">
            ...
            <div className="w-full max-w-7xl px-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-6">
                    ...
                    >
                        <div className="mb-3">
                            <p className="text-gray-400 text-sm uppercase tracking-wider">Total Photos</p>
                    ...
                    >
                        <div className="mb-3">
                            <p className="text-gray-400 text-sm uppercase tracking-wider">Total Storage</p>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    >
                        <div className="mb-3">
                            <p className="text-gray-400 text-sm uppercase tracking-wider">Photo Count Details</p>
                    ...
                    >
                        <div className="mb-3">
                            <p className="text-gray-400 text-sm uppercase tracking-wider">Used Storage</p>
                        ...
                        <div className="space-y-4 h-[320px]">
                                ...
                                return (
                                    <div key={`storage-${index}`} className="relative pt-1 group">
                                        <div className="flex items-center justify-between mb-1">
                                            <div className="text-sm font-medium text-gray-300 group-hover:text-teal-300 transition-colors">{item.name}</div>
                                            <div className="text-sm font-medium text-gray-300 group-hover:text-teal-300 transition-colors">
                                                {(item.size / 1024).toFixed(1)} GB
                                            </div>
                                        </div>
                                        <div className="flex h-3 overflow-hidden rounded bg-gray-700 group-hover:bg-gray-600 transition-colors">
                                            <div 
                            ...
                            <div className="pt-6 mt-6 border-t border-gray-700 py-4">
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-gray-300 font-medium">Đã sử dụng:</span>
                                    <span className="text-teal-400 font-bold">{totalStorageGB} GB / 5.0 GB</span>
                                </div>
                                <div className="w-full h-3 bg-gray-700 rounded-full mt-3 group-hover:bg-gray-600 transition-colors">
                                    <div 
