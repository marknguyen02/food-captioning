...
function Upload() {
  ...
  return (
    <div className="flex flex-col gap-5 w-full h-full items-center overflow-auto py-5">
      ...
      {!preview && <div className="flex justify-center gap-4">
      ...
      {!preview && <div className='w-full max-w-4xl'>
        <UploadAntd.Dragger 
          name="file"
          multiple={false}
          ...
          className="w-full h-full border-dashed border-gray-500 bg-gray-800 rounded-2xl text-center 
            hover:bg-gray-700 hover:border-cyan-500 transition-all duration-300 
        ...
        >
          ...
          <p className="text-cyan-400 text-4xl mb-4 relative z-10"><UploadOutlined /></p>
          <p className="text-lg font-semibold text-gray-300 relative z-10">
      ...
      {preview && (
        <div className="flex justify-center md:p-2.5 p-8 relative">
          <img 
            src={preview} 
      ...
      {caption.title && <div className="w-full max-w-4xl bg-gray-900 rounded-xl p-6 shadow-xl border border-gray-800">
        <div className="mb-6 rounded-lg overflow-hidden text-left">
          <div className="p-4 bg-slate-800">
            <h3 className="text-[22px] font-bold text-pink-300">
              Title
            </h3>
          </div>
          <div className="bg-gray-800 px-4 rounded-b-lg">
            <p className="text-gray-200 text-lg font-medium break-all text-left">{caption.title}</p>
            <div className="flex justify-end mt-2 pb-4">
              <Tooltip title="Copy Title">
                <button 
                  className="text-pink-300 hover:text-pink-400 transition-colors duration-300 transform hover:scale-125 text-[18px]"
        ...
        {caption.ingredients.length > 0 && 
          <div className="mb-6 rounded-lg overflow-hidden text-left">
            <div className="p-4 bg-slate-800">
              <h3 className="text-[22px] font-bold text-teal-400">
                Ingredients
              </h3>
            </div>
            <div className="bg-gray-800 px-4 rounded-b-lg text-left">
              <ul className="list-disc list-inside space-y-1 !py-0 text-amber-300 text-lg">
              ...
              <div className="flex justify-end mt-2 pb-4">
                <Tooltip title="Copy Ingredients">
                  <button 
                    className="text-emerald-400 hover:text-emerald-300 transition-colors duration-300 transform hover:scale-125 text-[18px]"
        ...
        {caption.instructions.length > 0 && 
          <div className="mb-6 rounded-lg overflow-hidden text-left">
            <div className="p-4 bg-slate-800">
            <h3 className="text-[22px] font-bold text-purple-300">
              Instructions
              </h3>
            </div>
            <div className="bg-gray-800 px-4 rounded-b-lg">
              ...
              <div className="flex justify-end mt-2 pb-4">
                <Tooltip title="Copy Instructions">
                  <button 
                    className="text-purple-400 hover:text-purple-300 transition-colors duration-300 transform hover:scale-125 text-[18px]"
        ...
        <div className='flex justify-center gap-8 mt-4'>
          <Tooltip title="Save">
            ...
            >
              <div className="bg-blue-900 p-2 rounded-full mb-1">
          ...
          <Tooltip title="Rate">
            ...
            >
              <div className="bg-yellow-900 p-2 rounded-full mb-1">
